...
class PoemReader:
    ...
    def _create_table(
        self, aws_region: str, table_name: str
    ...
    def _get_all_poem_ids(
        self, table: "boto3.resources.factory.dynamodb.Table"
    ) -> list[int]:
    ...
    def _read_poem_from_table(
        self, id: int, table: "boto3.resources.factory.dynamodb.Table"
    ) -> dict[str, str]:
